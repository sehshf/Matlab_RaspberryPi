...
#include "HelloWorld.h"                /* Model's header file */
...
void * base_rate()
{
  ...
  while (rtmGetErrorStatus(HelloWorld_M) == NULL && !rtmGetStopRequested
         (HelloWorld_M)) {
...
int_T main(int_T argc, const char_T *argv[])
{
  ...
  errStatus = rtmGetErrorStatus(HelloWorld_M);
...
/* Local Variables: */
/* compile-command: "make -f HelloWorld.mk" */
/* End: */
