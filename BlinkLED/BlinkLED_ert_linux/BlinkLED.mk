...
MODEL                   = BlinkLED
MODULES                 = BlinkLED_data.c ert_main.c rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c 
MAKEFILE                = BlinkLED.mk
MATLAB_ROOT             = C:\Matlab2014a\MATLAB\R2014a
ALT_MATLAB_ROOT         = C:\Matlab2014a\MATLAB\R2014a
MASTER_ANCHOR_DIR       = 
START_DIR               = C:\Users\ses\Documents\MATLAB\RaspberryPi\BlinkLED
S_FUNCTIONS             = dgio_sfun.c
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
COMPUTER                = PCWIN64
...
# Additional includes 
ADD_INCLUDES = \
	-I$(START_DIR)\BlinkLED_ert_linux \
	-I$(START_DIR) \
